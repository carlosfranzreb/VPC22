...
trn_set_name = "baseline/exp/am_nsf_data/debug_data"
val_set_name = "baseline/exp/am_nsf_data/debug_data"
...
trn_list = [["251-118436-0019"]]
# val_file_list: for each validation set
val_list = [["251-118436-0019"]]
...
input_dirs = [
    [
        "baseline/exp/am_nsf_data/debug_data/ppg",
        "baseline/exp/am_nsf_data/debug_data/xvector",
        "baseline/exp/am_nsf_data/debug_data/f0",
    ]
]
...
output_dirs = [["baseline/exp/am_nsf_data/debug_data/nsf_hifigan_output_wav"]]
output_dims = [1]
output_exts = [".wav"]
output_reso = [1]
output_norm = [False]
